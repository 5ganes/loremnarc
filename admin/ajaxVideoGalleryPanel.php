...
<div>
  <?php
	...
	{
	?>
  <div style="float: left; width: 230px; height: 175px; margin: 0 5px 5px 0px; border: 1px solid; overflow:hidden;">
    <div align="right">
    ...
    <div align="center">
      ...
      <textarea name="oldUrls[]" rows="3" cols="50" style=" padding: 5px 5px 0 5px;width: 218px;"><?php echo $videoRow['contents'] ?></textarea> 
    </div>
  </div>
  <?php
	}
